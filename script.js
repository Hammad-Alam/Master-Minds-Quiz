const MCQS = [
  ...
  {
    question: "For which do you made this Quiz App?",
    a: "Folio Interns",
    b: "Finders Interns",
    c: "SYNC Intern's",
    d: "iCode Interns",
...
next.addEventListener('click', () => {
  ...
  if (questionnum < MCQS.length) {
    ...
    showScore.innerHTML = `
    <img src="./images/oops.jpg" alt="oops" width="125px" height="100px">
    <h3>You scored ${score} out of ${MCQS.length}  Questions!<h3>
    <marquee behavior="scroll">Sorry, you can't pass the quiz.</marquee>`; 
    ...
    res.style.display = "block";
    showScore.innerHTML = `
    <img src="./images/clap.jpg" alt="clap" width="125px" height="100px">
    <h3>You scored ${score} out of ${MCQS.length}  Questions!<h3>
    <marquee behavior="scroll">Well Played! Keep it Up.</marquee>`; 
    showScore.classList.remove('scoreArea');
  } else {
    quiz.style.display = "none";
    res.style.display = "block";
    showScore.innerHTML = `
    <img src="./images/trophy.jpg" alt="trophy" width="125px" height="100px">
    <h3>You scored ${score} out of ${MCQS.length}  Questions!<h3>
    <marquee behavior="scroll">Congratulations!</marquee>`; 
    showScore.classList.remove('scoreArea');
  }
});
